...
export function Input({ className, type = "text", maxLength = SHORT, ref, ...props }: Props) {
  return <input ref={ref} type={type} maxLength={maxLength} className={cn(fieldClass, "min-h-11", className)} {...props} />;
}
